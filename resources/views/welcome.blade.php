    ...
    <div id="list_product">
        ...
        <div v-else id="paginationProduct">
                ...
                <div class="col-md-4" v-for='(item,index) in list'>
                    <div class="product-image-wrapper rounded-lg">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <div class="img-product">
                                    <a @click=" routeShowProduct(item['id'])"><img :src="item['image']" alt="img"
                                            class="rounded-circle transition-img"></a>
                                </div>
                                <div class="">
            ...
            <div class="col-12 d-flex justify-content-center" style="">
                <pagination-component :total-pages=row :current-page="currentPage" @pagechanged="onPageChange">
